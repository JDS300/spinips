...
PLACEMENTS: dict[str, dict] = {
    ...
    "PetInfoWindow": P(851, 554, 356, 209, show=0),
    "PetInfoWindow_1": P(1008, 554, 356, 209, show=0),
    "PetInfoWindow_2": P(1008, 554, 356, 209, show=0),
...
def adaptive_placements(profile: ResolutionProfile, preset: str) -> dict[str, dict]:
    ...
    placements = {
        ...
        "PetInfoWindow": q(pet_x, pet_y, 356, 209, show=0),
...
XML_SIZES = {
    ...
    "PetInfoWindow": (356, 209), "BuffWindow": (216, 640),
