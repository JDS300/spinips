...
SOURCE_REQUIRED = (
    ...
    "loremaster/tests/test_linux_capture.py",
    ...
    "loremaster/tests/test_debuff_timer.py",
    "loremaster/tests/test_debuff_integration.py",
    "loremaster/tests/test_debuff_fixtures.py",
    "loremaster/tests/test_control_fixtures.py",
    "loremaster/tests/test_engine_protocol.py",
    "loremaster/tests/test_desktop_worker.py",
    "loremaster/tests/test_adventure_journal.py",
    "loremaster/tests/test_ability_categories.py",
    "loremaster/tests/test_raid_context.py",
    ...
    "loremaster-desktop/electron/portable-updater.ts",
    "loremaster-desktop/electron/spinui-updater.ts",
    "loremaster-desktop/scripts/test-portable-updater.cjs",
    "loremaster-desktop/scripts/test-spinui-updater.cjs",
    ...
    "tools/diagnose_debuff_timers.py",
    ...
    "loremaster/adventure_journal.py",
    "loremaster/raid_context.py",
    "loremaster/weekly_tracker.py",
    "loremaster-desktop/electron/item-intelligence.ts",
    "loremaster-desktop/src/LootChronicle.tsx",
    "loremaster-desktop/src/visualIdentity.ts",
    "loremaster-desktop/scripts/test-item-intelligence.cjs",
