...
DEBUFF_SPELLS: tuple[DebuffSpell, ...] = (
    ...
    DebuffSpell("Heat Blood", "dot", "level_half_roundup", 6, None, ((10, 5), (12, 6))),
...
DEBUFF_LANDING_COMPATIBILITY: dict[str, frozenset[str]] = {
    ...
    "malosi": frozenset(['Malosi']),
    "slows_down": frozenset(['Languid Pace', 'Shiftless Deeds', 'Tepid Deeds']),
    "tashan": frozenset(['Tashani', 'Tashania', 'Tashina']),
    "yawns": frozenset(['Drowsy', "Tagar's Insects", "Togor's Insects", 'Walking Sleep']),
}
