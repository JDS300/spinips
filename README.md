...
- **Attack state can be unmistakable.** The default PlayerWindow keeps its restrained native combat pulse; choose **Display Types -> High-Visibility Attack Frame** (Alternate 1) for a solid pure-red nine-pixel perimeter and pulsing red wash driven directly by EverQuest's auto-attack state.
